...
import { Shield, Mail, Lock, Eye, EyeOff, User, Phone, ArrowLeft } from 'lucide-react-native';
...
export default function SignupScreen() {
  ...
  async function handleSignup() {
    ...
    const { error } = await signUp(email, password, fullName, 'citizen', phone);
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Create your emergency account</Text>
          </View>

          <View style={styles.form}>
            <Text style={styles.formTitle}>Get Started</Text>
            <Text style={styles.formSubtitle}>Join the SafetyFirst community</Text>
